  ...
  return (
    <section className="relative overflow-hidden pt-20 pb-16">
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div
          className="absolute rounded-full bg-[#7d8597] opacity-30"
          style={{ width: 520, height: 520, top: -120, left: -140 }}
          animate={{ x: [0, 30, -20, 0], y: [0, -30, 20, 0] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute rounded-full bg-[#5c677d] opacity-20"
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-8">
            <div className="max-w-xl">
              <p className="text-sm font-semibold uppercase tracking-wide text-[#023e7d]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link
                to="/subscribe"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#0353a4] to-[#023e7d] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:shadow-md"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#5c677d] bg-white px-6 py-3 text-sm font-semibold text-[#023e7d] shadow-sm transition hover:bg-[#7d8597]/60"
              >
                Contact Us
              </Link>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-lg backdrop-blur">
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="rounded-2xl bg-slate-50 p-4">
                  ...
                  <p className="mt-1 text-2xl font-bold text-[#023e7d]">96%</p>
                </div>
                <div className="rounded-2xl bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase text-slate-500">
                    Daily Trade Opportunities
                  </p>
                  <p className="mt-1 text-2xl font-bold text-[#023e7d]">
                    1–2 Setups
                  </p>
                </div>
              </div>
