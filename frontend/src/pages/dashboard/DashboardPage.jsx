...
import {
    TrendingUp, LogOut, User, Mail, Globe, MapPin,
    BarChart2, TrendingDown, ShieldCheck, ArrowUpRight,
} from "lucide-react";
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#C8E6E2]/20 via-white to-[#9ED5D1]/15">
            ...
            <header className="sticky top-0 z-30 backdrop-blur-md bg-white/80 border-b border-slate-100 shadow-sm">
                <div className="max-w-5xl mx-auto px-5 h-14 flex items-center justify-between">
                    ...
                    >
                        ...
                        <span className="font-bold text-slate-800 text-sm tracking-tight">Index Money</span>
                    </button>
            ...
            <main className="max-w-5xl mx-auto px-5 py-10">
                ...
                >
                    ...
                    <svg className="absolute inset-0 w-full h-full opacity-[0.06] pointer-events-none" viewBox="0 0 700 140" preserveAspectRatio="none">
                        <polyline points="0,110 120,80 240,95 360,50 480,30 600,15 700,5" stroke="white" strokeWidth="2" fill="none" strokeLinecap="round" />
                        <polyline points="0,130 120,110 240,120 360,80 480,60 600,50 700,35" stroke="white" strokeWidth="1.5" fill="none" strokeDasharray="5 4" strokeLinecap="round" />
                    </svg>
                    ...
                    <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight">
                                Welcome back,{" "}
                                <span className="text-[#9ED5D1]">{user.fullName || "Trader"}</span> 👋
                            </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    <StatCard icon={BarChart2} label="Portfolio" value="Active" sub="Ready to track" color="#3A9295" delay={0.1} />
                    <StatCard icon={TrendingUp} label="Win Rate" value="96%" sub="Historical avg" color="#63C1BB" delay={0.18} />
                    <StatCard icon={TrendingDown} label="Max Drawdown" value="4%" sub="Controlled risk" color="#105F68" delay={0.26} />
                </div>
                ...
                >
                    <div className="flex items-center gap-3 mb-5">
                        ...
                        <div>
                            <p className="font-bold text-slate-800 text-sm">Account Profile</p>
                            <p className="text-xs text-slate-400">Your registered information</p>
                        </div>
                    </div>
