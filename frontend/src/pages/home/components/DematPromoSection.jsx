          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-teal-600 px-7 py-3.5 text-sm font-semibold text-white shadow-md transition-colors duration-200 hover:bg-teal-700 sm:w-auto"
              >
                Open Demat Account
