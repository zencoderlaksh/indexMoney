...
const niftyPrices = [
    21500, 21900, 22300, 22100, 22700, 23200,
    22800, 23500, 24100, 23700, 24400, 24900,
];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <ChartCard delay={0.22}>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-8">
                            <div className="relative w-52 h-52 flex-shrink-0 mx-auto sm:mx-0">
                            ...
                            <div className="flex flex-col gap-4 flex-1 w-full">
                                ...
                                <div className="bg-teal-50 border border-teal-100 rounded-xl px-4 py-3 mt-1">
                                    <p className="text-xs text-teal-700 font-medium">
                                        📊 Based on{" "}
                                        <span className="font-bold">500+</span> trades
