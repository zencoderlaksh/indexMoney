          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-8 items-start">
            ...
            >
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-6">
                  <h2 className="text-base font-extrabold text-slate-800 mb-5 flex items-center gap-2">
                    <CreditCard className="w-4 h-4 text-[#3A9295]" /> Payment
                    Method
                  </h2>
                      ...
                      >
                        <span
                          className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${
                            paymentMethod === id ? "bg-[#105F68]" : (
                              "bg-slate-100"
                            )
                          }`}
                        >
                          <PMIcon
                            className={`w-4 h-4 ${paymentMethod === id ? "text-white" : "text-slate-500"}`}
                            strokeWidth={2}
                          />
                        </span>
                        <span
                          className={`text-sm font-semibold ${paymentMethod === id ? "text-[#105F68]" : "text-slate-600"}`}
                        >
                          {label}
                        </span>
                        {paymentMethod === id && (
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-xl px-5 py-4 flex items-center justify-between mb-5">
                  <div>
                    ...
                    <p className="text-[#105F68] text-2xl font-extrabold">
                      {plan.price}
                    </p>
                ...
                <motion.button
                  ...
                  whileHover={
                    !processing ?
                      {
                        scale: 1.02,
                        boxShadow: "0 12px 32px rgba(58,146,149,0.38)",
                      }
                    : {}
                  }
